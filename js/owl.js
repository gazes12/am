...
$('.heroes-dots .col').click(function () {
...
function addAnimation(index){
    ...
    $(`<h1 class="text-center text-lg-start heroes-info__name animate animation-slideToRight animation-duration-fast animation-fillmode-forwards">${$('.heroes-carousel .owl-item.active').find('.heroes-carousel__item').data('name')}</h1>`).appendTo('.heroes-info');
    $(`<p class="text-center text-lg-start heroes-info__desc animate animation-slideToRight animation-duration-slow animation-fillmode-forwards">${$('.heroes-carousel .owl-item.active').find('.heroes-carousel__item').data('desc')}</p>`).appendTo('.heroes-info');
